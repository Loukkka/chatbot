...
(function () {
    ...
    css.textContent = [
        ...
        ".cb-m{padding:10px 14px;border-radius:16px;max-width:84%;line-height:1.55;word-wrap:break-word;white-space:pre-wrap;font-size:13.5px;letter-spacing:0.01em}",
